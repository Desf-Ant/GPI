...
/**
 * Mutant permettant de vérifier si les tests détectent 
 * le cas du triangle plat.
 * 
 * @author Camille Constant
 *
 */
public class TriangleMutant8 extends Triangle{

	public TriangleMutant8(int a, int b, int c) {
		super(a,b,c);
	}
